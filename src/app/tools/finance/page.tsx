...
const PREVIEWS: Record<string, { before?: string; after?: string }> = {
  "percentage-calculator": { after: "/previews/fin/percentage-calculator.jpg" },
  "loan-calculator": { after: "/previews/fin/loan-calculator.jpg" },
  "discount-calculator": { after: "/previews/fin/discount-calculator.jpg" },
  "tip-calculator": { after: "/previews/fin/tip-calculator.jpg" },
  "salary-calculator": { after: "/previews/fin/salary-calculator.jpg" },
  "compound-interest": { after: "/previews/fin/compound-interest.jpg" },
  "vat-calculator": { after: "/previews/fin/vat-calculator.jpg" },
  "mortgage-calculator": { after: "/previews/fin/mortgage-calculator.jpg" },
  "fuel-economy-calculator": { after: "/previews/fin/fuel-economy-calculator.jpg" },
};
...
export const metadata: Metadata = category
  ? {
      title: "Finance Calculators - Loans, Mortgage, Interest & More | MultiTool",
