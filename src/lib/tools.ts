  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Convert length and distance units instantly: cm to inches, meters to feet, km to miles — see all units at once.",
        keywords: [
          "length converter",
          "cm to inches",
          "inches to cm",
      ...
      },
      {
        ...
        description: "Convert weight units instantly: kg to lbs, pounds to kg, grams to ounces, stones and tons — all units at once.",
        keywords: [
          "weight converter",
          "kg to lbs",
          "lbs to kg",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        slug: "xml-formatter",
        name: "XML Formatter",
        description: "Format and validate XML online — beautify with 2 or 4 space indentation, minify, and catch syntax errors instantly.",
        keywords: [
          "xml formatter",
          "format xml online",
          "xml beautifier",
      ...
      },
      {
        slug: "yaml-formatter",
        name: "YAML Formatter",
        description: "Format and validate YAML online with consistent indentation and instant error messages with line numbers.",
        keywords: [
          "yaml formatter",
          "format yaml online",
          "yaml validator",
      ...
      },
      {
        slug: "sql-formatter",
        name: "SQL Formatter",
        description: "Format SQL queries online with proper indentation and keyword casing. Supports PostgreSQL, MySQL, SQLite, T-SQL and more.",
        keywords: [
          "sql formatter",
          "format sql online",
          "sql beautifier",
      ...
      },
      {
        ...
        description: "Convert JSON to YAML and YAML to JSON online, both directions, with instant validation and clear error messages.",
        keywords: [
          "json to yaml",
          "yaml to json",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        slug: "image-resizer",
        name: "Image Resizer",
        description: "Resize images to exact pixel dimensions online. Keep aspect ratio or set custom width and height — private, no upload.",
        keywords: [
          "image resizer",
          "resize image online",
          "resize photo",
      ...
      },
      {
        ...
        description: "Convert HEIC and HEIF photos (iPhone default) to universal JPG online. Choose quality, download instantly — no upload.",
        keywords: [
          "heic to jpg",
          "convert heic to jpg",
          "heic converter",
      ...
      },
      {
        ...
        description: "Convert WebP images to JPG online — one file or a whole batch with ZIP download. Free, private, no watermark.",
        keywords: [
          "webp to jpg",
          "convert webp to jpg",
          "webp to jpeg",
      ...
      },
      {
        ...
        description: "Convert PNG images to WebP and cut file size by 25%+ with the quality you choose. Batch + ZIP download, fully private.",
        keywords: [
          "png to webp",
          "convert png to webp",
          "png webp converter",
      ...
      },
      {
        ...
        description: "See the EXIF metadata hidden in photos (camera, date, GPS) and download a clean copy with all metadata removed.",
        keywords: [
          "exif viewer",
          "exif remover",
          "remove exif",
      ...
      },
      {
        ...
        description: "Rotate images 90° or 180° and flip horizontally or vertically — fix sideways photos and mirrored selfies. Free, private, no upload.",
        keywords: [
          "rotate image",
          "flip image online",
          "rotate photo",
      ...
      },
      {
        ...
        description: "Convert photos to black and white with adjustable intensity, plus a sepia mode. Classic luminance math, live preview.",
        keywords: [
          "grayscale image",
      ...
      },
      {
        ...
        description: "Frame photos with solid, double or polaroid-style borders — custom width and color, live preview.",
        keywords: [
          "add border to image",
          "photo border online",
      ...
      },
      {
        slug: "merge-images",
        name: "Merge Images",
        description: "Combine 2–6 images side by side or stacked — before/after comparisons, screenshots and step sequences in one file.",
        keywords: [
          "merge images online",
      ...
      },
      {
        ...
        description: "Protect photos with text watermarks: diagonal, tiled or corner — opacity, size and color control.",
        keywords: [
      ...
      },
      {
        ...
        description: "Write text over photos — quotes, promos and labels — with position grid, outline and color control.",
        keywords: [
          "add text to image",
          "write on photo",
          "text over image",
      ...
      },
      {
        slug: "meme-generator",
        name: "Meme Generator",
        description: "Turn any image into a meme — classic top/bottom captions in the meme typeface, with auto text wrapping.",
        keywords: [
          "meme generator",
          "meme maker online",
          "create meme",
      ...
      },
      {
        ...
        description: "Hide faces, plates, IDs and messages before sharing — drag a rectangle and blur or pixelate exactly that region.",
        keywords: [
          "blur image online",
          "pixelate image",
          "blur face photo",
      ...
      },
      {
        ...
        description: "Create polished profile pictures: circle or square crops with zoom control, exported at 512×512.",
        keywords: [
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Delete pages from a PDF online — select pages to remove or keep and download instantly. Private, free, no upload.",
        keywords: [
          "remove pages from pdf",
          "delete pdf pages",
          "pdf page remover",
      ...
      },
      {
        slug: "crop-pdf",
        name: "Crop PDF",
        description: "Trim margins from PDF pages by percentage — cut white borders from scans and exports on every page at once.",
        keywords: [
          "crop pdf",
          "trim pdf margins",
          "remove pdf borders",
      ...
      },
      {
        slug: "flatten-pdf",
        name: "Flatten PDF",
        description: "Turn interactive form fields into permanent page content — the final-document format portals and banks require.",
        keywords: [
          "flatten pdf",
          "flatten pdf form",
      ...
      },
      {
        ...
        description: "Convert Markdown to a clean, selectable-text PDF — headings, lists, bold, code and links on proper A4 pages.",
        keywords: [
          "markdown to pdf",
          "md to pdf online",
          "convert markdown",
